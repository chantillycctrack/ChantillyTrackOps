<template>
  <div class="dark">
    <div class="min-h-screen bg-[#0F172A] text-gray-100 font-sans transition-colors duration-300">
      
      <header class="bg-black border-b border-[#4B2E83]/30 px-6 py-4 flex justify-between items-center shadow-sm">
        ...
        <div class="flex items-center gap-6">
          ...
          <template v-else-if="isAuthorizedCoach">
            <div class="flex items-center gap-4 border-r border-gray-700 pr-4 mr-2">
      ...
      <main class="container mx-auto px-4 py-12 flex justify-center">
        <div class="w-full max-w-4xl">
          ...
          <template v-if="isAdmin && isAuthorizedCoach">
            <div class="flex gap-6 mb-8 border-b border-gray-800 overflow-x-auto">
